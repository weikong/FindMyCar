...
public class RoutePlanDemo extends Activity implements BaiduMap.OnMapClickListener,
    ...
    LatLng fromNodeL = new LatLng(30.545678, 104.081898);
    LatLng toNodeL = new LatLng(30.543649, 104.080613);
    ...
    public void searchButtonProcess(View v) {
        ...
        PlanNode stNode = PlanNode.withLocation(fromNodeL);
        PlanNode enNode = PlanNode.withLocation(toNodeL);
