...
import com.king.smart.car.mysmartcarapp.ui.alarm.AlarmBaseActivity;
import com.king.smart.car.mysmartcarapp.ui.view.TopActionBarView;

import java.util.Calendar;

public class AlarmPreferencesActivity extends AlarmBaseActivity {
...
//            tvDel.setVisibility(View.VISIBLE);
            actionBarView.setTvActionRightVisiable(View.VISIBLE);
        } else {
            setMathAlarm(new Alarm());
//            tvDel.setVisibility(View.GONE);
            actionBarView.setTvActionRightVisiable(View.INVISIBLE);
        }
    ...
    private void initActionBar() {
        ...
        actionBarView.setTvActionTitleText(getString(R.string.item_tool_alarm_setting));
        actionBarView.setTvActionRightText(getString(R.string.action_delete));
        actionBarView.setTvActionRightTextColor(getResources().getColor(R.color.color_d9261b));
        actionBarView.setClickListener(actionListener);
    }

    private void saveAlarmClock() {
        if (getMathAlarm().getId() < 1) {
            AlarmDBHelper.create(getMathAlarm());
        } else {
            AlarmDBHelper.update(getMathAlarm());
        }
