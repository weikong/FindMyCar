...
public class AlarmListAdapter extends BaseAdapter {
    ...
    public static final String ALARM_FIELDS[] = {AlarmTable.Columns.COLUMN_ALARM_ACTIVE,
            AlarmTable.Columns.COLUMN_ALARM_TIME, AlarmTable.Columns.COLUMN_ALARM_DAYS};
