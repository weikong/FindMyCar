 ...
 */
public class MyInputFixNameDialog extends Dialog {
    ...
    public MyInputFixNameDialog(Context context) {
//        super(context);
        this(context, R.style.Dialog_input);
    }

    public MyInputFixNameDialog(Context context, int themeResId) {
        super(context, themeResId);
    }

    protected MyInputFixNameDialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etInput.setHint(getContext().getResources().getString(R.string.txt_input_hint_fix_name));
